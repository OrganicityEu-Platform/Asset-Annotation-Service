...
@SpringBootApplication(scanBasePackages = {"eu.oc.annotations.config", "eu.oc.annotations.controller", "eu.oc.annotations.dto.converter", "eu.oc.annotations.handlers", "eu.oc.annotations.service"})
@EnableJpaRepositories(basePackages = "eu.oc.annotations.repositories")
